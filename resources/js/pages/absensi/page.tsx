...
import { useAttendanceSummary } from './data-summay';
import { DeleteDialog } from './delete';
import ModalSchedule from './modal';
import AttendanceSummaryCards from './summary';
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Data Presensi Guru', href: '/absensi' }];
...
const PageSchedule = () => {
    ...
    const { summary, loadingku, refetch } = useAttendanceSummary();
    ...
    const handleEdit = (jadwal: AttendanceTypes) => {
        setModalMode('edit');
        setEditData(jadwal);
        setModalOpen(true);
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <AttendanceSummaryCards summary={summary ?? undefined} isLoading={loading} />
