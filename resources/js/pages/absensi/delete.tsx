...
export const DeleteDialog: React.FC<DeleteDialogProps> = ({ scheduleId, scheduleName, onDeleted }) => {
    ...
    const handleConfirmDelete = () => {
        setLoading(true);
        api.delete(`/attendances/${scheduleId}`)
            .then(() => onDeleted())
            .catch((err) => console.error('Gagal hapus Absensi:', err))
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Absensi <strong>{scheduleName || 'ini'}</strong> akan dihapus secara permanen. Tindakan ini tidak dapat dibatalkan.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
